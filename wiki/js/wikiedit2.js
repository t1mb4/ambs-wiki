...
WikiEdit.prototype.init = function(id, name, nameClass, imgPath) {
 ...
 if (isMZ && navigator.userAgent.substr(navigator.userAgent.indexOf("Gecko/index.html")+6,4)=="2003" ) {
  this.mzBugFixed=(navigator.userAgent.substr(navigator.userAgent.indexOf("Gecko/index.html")+6,8)>20030510);
  mzOld=(navigator.userAgent.substr(navigator.userAgent.indexOf("Gecko/index.html")+6,8)<20030110);
  if (mzOld) this.MZ=false;
  else this.MZ=true;
 }
 if (isMZ && navigator.userAgent.substr(navigator.userAgent.indexOf("Gecko/index.html")+6,4)=="2002" ) this.MZ=false;
